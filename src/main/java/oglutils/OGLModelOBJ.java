...
*/
	public OGLModelOBJ(GL4 gl, String modelPath) {
	...
	private OGLBuffers toOGLBuffers(GL4 gl, FloatBuffer verticesBuf, FloatBuffer normalsBuf, FloatBuffer texCoordsBuf){
		OGLBuffers buffers;
